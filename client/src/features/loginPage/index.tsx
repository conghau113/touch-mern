  ...
  return (
    <>
      <Space className='flex w-4full bg-main-purple items-center justify-center cursor-pointer'>
        <div className='flex items-center justify-center h-10 w-10 rounded-full bg-main-light'>
          <Image preview={false} width={30} src={logo} />
        </div>
        <Typography className='font-bold text-[40px] text-main-light  text-center cursor-pointer'>TOUCH!</Typography>
      </Space>
      <div className='w-5/12 m-auto my-5'>
        <PrimaryCard className='bg-main-light shadow-sm '>
